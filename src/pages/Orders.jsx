...
const Orders = () => {
        ...
        setOrders((prevOrders) =>
          prevOrders.map((order) =>
            order.id === selectedOrderId
              ? { ...order, status: { id: 9, name: "Chờ xử lý trả hàng" } }
              : order
          )
        );
  ...
  return (
    <div>
      ...
      >
        <span>
          Email người đặt: <span className="text-quest">{orderInfo.email}</span>
        </span>{" "}
        <br />
        <span>
          Địa chỉ nhận hàng:{" "}
              ...
              <Col span={12}>
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Vui lòng chọn hoặc nhập lý do trả hàng",
                    },
                  ]}
                >
                  <Radio.Group
                  ...
                  >
                    <Radio value="store_error">
                      Cửa hàng gửi sai, thiếu sản phẩm
                    </Radio>
              ...
              <Col span={12}>
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Vui lòng tải lên video minh chứng",
                    },
                  ]}
                >
                  <Upload
